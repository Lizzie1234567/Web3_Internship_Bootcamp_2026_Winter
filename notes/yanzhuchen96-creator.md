...
区块链是一个由很多节点共同维护的**去中心化**账本，按时间顺序把交易打包成区块，串成链，并且记录一旦写入就很难被篡改。
...
以太坊更像是一台大家共享的“世界计算机”，能够通过执行智能合约来实现很多功能，有更完整的区块链生态；而比特币作为“数字黄金”，主要在金融相关的领域使用（例如储值和投资），很少有涉及到其他领域的场景。
